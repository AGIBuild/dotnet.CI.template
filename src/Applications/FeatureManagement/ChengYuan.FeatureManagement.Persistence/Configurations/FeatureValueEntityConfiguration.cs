...
public sealed class FeatureValueEntityConfiguration : IEntityTypeConfiguration<FeatureValueEntity>
{
    public void Configure(EntityTypeBuilder<FeatureValueEntity> builder)
    {
